...
export const routeComponents = {
    ...
    '/teachers': lazyLoad(() => import('@/features/teachers/TeachersList').then(m => ({ default: m.TeachersList }))),
    '/teachers/add': lazyLoad(() => import('@/features/teachers/AddTeacher').then(m => ({ default: m.AddTeacher }))),
    '/teachers/:id/edit': lazyLoad(() => import('@/features/teachers/EditTeacher').then(m => ({ default: m.EditTeacher }))),
    '/teachers/:id': lazyLoad(() => import('@/features/teachers/TeacherProfile').then(m => ({ default: m.TeacherProfile }))),
    ...
    '/universities': lazyLoad(() => import('@/features/universities/UniversitiesList').then(m => ({ default: m.UniversitiesList }))),
    '/universities/add': lazyLoad(() => import('@/features/universities/AddUniversity').then(m => ({ default: m.AddUniversity }))),
    '/universities/:id/edit': lazyLoad(() => import('@/features/universities/EditUniversity').then(m => ({ default: m.EditUniversity }))),
    '/campus': lazyLoad(() => import('@/features/campus/CampusesList').then(m => ({ default: m.CampusesList }))),
    '/campus/add': lazyLoad(() => import('@/features/campus/AddCampus').then(m => ({ default: m.AddCampus }))),
    '/campus/:id/edit': lazyLoad(() => import('@/features/campus/EditCampus').then(m => ({ default: m.EditCampus }))),
    '/faculties': lazyLoad(() => import('@/features/faculties/FacultiesList').then(m => ({ default: m.FacultiesList }))),
    '/faculties/add': lazyLoad(() => import('@/features/faculties/AddFaculty').then(m => ({ default: m.AddFaculty }))),
    '/faculties/:id/edit': lazyLoad(() => import('@/features/faculties/EditFaculty').then(m => ({ default: m.EditFaculty }))),
    '/programs': lazyLoad(() => import('@/features/programs/ProgramsList').then(m => ({ default: m.ProgramsList }))),
    '/programs/add': lazyLoad(() => import('@/features/programs/AddProgram').then(m => ({ default: m.AddProgram }))),
    '/programs/:id/edit': lazyLoad(() => import('@/features/programs/EditProgram').then(m => ({ default: m.EditProgram }))),
    '/academic-years': lazyLoad(() => import('@/features/academic-years/AcademicYearsList').then(m => ({ default: m.AcademicYearsList }))),
    '/academic-years/add': lazyLoad(() => import('@/features/academic-years/AddAcademicYear').then(m => ({ default: m.AddAcademicYear }))),
    '/academic-years/:id/edit': lazyLoad(() => import('@/features/academic-years/EditAcademicYear').then(m => ({ default: m.EditAcademicYear }))),
    '/semesters': lazyLoad(() => import('@/features/semesters/SemestersList').then(m => ({ default: m.SemestersList }))),
    '/semesters/add': lazyLoad(() => import('@/features/semesters/AddSemester').then(m => ({ default: m.AddSemester }))),
    '/semesters/:id/edit': lazyLoad(() => import('@/features/semesters/EditSemester').then(m => ({ default: m.EditSemester }))),
    '/levels': lazyLoad(() => import('@/features/levels/LevelsList').then(m => ({ default: m.LevelsList }))),
    '/levels/add': lazyLoad(() => import('@/features/levels/AddLevel').then(m => ({ default: m.AddLevel }))),
    '/levels/:id/edit': lazyLoad(() => import('@/features/levels/EditLevel').then(m => ({ default: m.EditLevel }))),
};
...
const dynamicRoutes = [
    ...
    { pattern: /^\/universities\/([^/]+)\/edit$/, key: '/universities/:id/edit' },
    { pattern: /^\/campus\/([^/]+)\/edit$/, key: '/campus/:id/edit' },
    { pattern: /^\/faculties\/([^/]+)\/edit$/, key: '/faculties/:id/edit' },
    { pattern: /^\/programs\/([^/]+)\/edit$/, key: '/programs/:id/edit' },
    { pattern: /^\/academic-years\/([^/]+)\/edit$/, key: '/academic-years/:id/edit' },
    { pattern: /^\/semesters\/([^/]+)\/edit$/, key: '/semesters/:id/edit' },
    { pattern: /^\/levels\/([^/]+)\/edit$/, key: '/levels/:id/edit' },
];
